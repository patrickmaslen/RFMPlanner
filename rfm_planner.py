...
class RFMPlanner:
    ...
    def initGui(self):
        ...
        self.report_named_assets_action = QAction("Named assets (e.g. towns)", self.iface.mainWindow())
        ...
        self.reports_menu.addAction(self.report_named_assets_action)
        ...
        self.report_named_assets_action.triggered.connect(rfm_library.list_named_assets)
