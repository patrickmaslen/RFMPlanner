...
<qgis version="2.18.16" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="threshold_age">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="shs_target">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="cib_target">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="lrr_target">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <renderer-v2 attr="fuel_type" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      ...
      <category render="true" symbol="4" value="Grassland / cropped" label="Grassland / cropped"/>
      <category render="true" symbol="5" value="Hummock grassland" label="Hummock grassland"/>
      <category render="true" symbol="6" value="Mallee heath" label="Mallee heath"/>
        ...
        <layer pass="0" class="LinePatternFill" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="line" name="@0@0">
            <layer pass="0" class="SimpleLine" locked="0">
              ...
              <prop k="line_color" v="245,162,122,255"/>
        ...
        <layer pass="0" class="LinePatternFill" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="line" name="@3@1">
            <layer pass="0" class="SimpleLine" locked="0">
              ...
              <prop k="draw_inside_polygon" v="0"/>
              <prop k="joinstyle" v="bevel"/>
              <prop k="line_color" v="64,168,40,255"/>
              <prop k="line_style" v="solid"/>
        ...
        <layer pass="0" class="LinePatternFill" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="line" name="@4@1">
            <layer pass="0" class="SimpleLine" locked="0">
              ...
              <prop k="draw_inside_polygon" v="0"/>
              <prop k="joinstyle" v="bevel"/>
              <prop k="line_color" v="200,214,152,255"/>
              <prop k="line_style" v="solid"/>
              <prop k="line_width" v="0.26"/>
              <prop k="line_width_unit" v="MM"/>
              <prop k="offset" v="0"/>
  ...
  <aliases>
    <alias field="fuel_type" index="0" name=""/>
    <alias field="threshold_age" index="1" name=""/>
    <alias field="shs_target" index="2" name=""/>
    <alias field="cib_target" index="3" name=""/>
    <alias field="lrr_target" index="4" name=""/>
    <alias field="pk" index="5" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="threshold_age"/>
      <column width="-1" hidden="0" type="field" name="shs_target"/>
      <column width="-1" hidden="0" type="field" name="cib_target"/>
      <column width="-1" hidden="0" type="field" name="lrr_target"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="threshold_age" expression=""/>
    <default field="shs_target" expression=""/>
    <default field="cib_target" expression=""/>
    <default field="lrr_target" expression=""/>
