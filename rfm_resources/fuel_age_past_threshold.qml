...
<qgis version="2.18.16" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="target" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="30" label="LRR (Need 30% below t'hold)"/>
      <category render="true" symbol="1" value="45" label="LRR (Need 45% below t'hold)"/>
      <category render="true" symbol="2" value="50" label="CIB (Need 50% below t'hold)"/>
      <category render="true" symbol="3" value="60" label="SHS (Need 60% below t'hold)"/>
    </categories>
    <symbols>
  ...
  <displayfield>fuel_type</displayfield>
  <label>0</label>
  <labelattributes>
...
def my_form_open(dialog, layer, feature):
  ...
  <previewExpression>COALESCE( "fuel_type", '&lt;NULL>' )</previewExpression>
