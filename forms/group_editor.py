...
# Form implementation generated from reading ui file 'editing_assistant.ui'
#
# Created: Tue Apr 30 16:08:23 2019
...
class Ui_GroupEditorMainWindow(object):
    def setupUi(self, GroupEditorMainWindow):
        GroupEditorMainWindow.setObjectName(_fromUtf8("GroupEditorMainWindow"))
        GroupEditorMainWindow.resize(800, 861)
        self.centralwidget = QtGui.QWidget(GroupEditorMainWindow)
        ...
        GroupEditorMainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QtGui.QMenuBar(GroupEditorMainWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 800, 31))
        self.menubar.setObjectName(_fromUtf8("menubar"))
        GroupEditorMainWindow.setMenuBar(self.menubar)
        self.statusbar = QtGui.QStatusBar(GroupEditorMainWindow)
        self.statusbar.setObjectName(_fromUtf8("statusbar"))
        GroupEditorMainWindow.setStatusBar(self.statusbar)

        self.retranslateUi(GroupEditorMainWindow)
        QtCore.QMetaObject.connectSlotsByName(GroupEditorMainWindow)

    def retranslateUi(self, GroupEditorMainWindow):
        GroupEditorMainWindow.setWindowTitle(_translate("GroupEditorMainWindow", "Group Editing", None))
        self.groupBox.setTitle(_translate("GroupEditorMainWindow", "Column for editing", None))
        self.rad_fma.setText(_translate("GroupEditorMainWindow", "fma", None))
        self.rad_asset_class.setText(_translate("GroupEditorMainWindow", "asset_class", None))
        self.rad_resilience.setText(_translate("GroupEditorMainWindow", "resilience", None))
        self.label_2.setText(_translate("GroupEditorMainWindow", "RFM Group Editing Assistant", None))
        self.label_4.setText(_translate("GroupEditorMainWindow", "Removes excess spaces and ensures \n"
"correct upper/lower case", None))
        self.btn_detailed_edit.setText(_translate("GroupEditorMainWindow", "Go to Detailed Editing", None))
        self.label_5.setText(_translate("GroupEditorMainWindow", "Update selected features from map or rows from attribute table:", None))
        self.rad_fma_anom.setText(_translate("GroupEditorMainWindow", "fma", None))
        self.rad_asset_class_anom.setText(_translate("GroupEditorMainWindow", "asset_class", None))
        self.rad_resilience_anom.setText(_translate("GroupEditorMainWindow", "resilience", None))
        self.rad_any_anom.setText(_translate("GroupEditorMainWindow", "any of the above", None))
        self.btn_select_anomalies.setText(_translate("GroupEditorMainWindow", "OK", None))
        self.label_6.setText(_translate("GroupEditorMainWindow", "Select rows with invalid values for:", None))
        self.btn_case_errors.setText(_translate("GroupEditorMainWindow", "Fix case and\n"
"space errors", None))
        self.lbl_selection_count.setText(_translate("GroupEditorMainWindow", "selected feature(s)", None))
        self.label.setText(_translate("GroupEditorMainWindow", "Database layer", None))
        self.btn_set_values.setText(_translate("GroupEditorMainWindow", "OK", None))
        self.label_3.setText(_translate("GroupEditorMainWindow", "Set value for selected rows to:", None))
        self.label_7.setText(_translate("GroupEditorMainWindow", "Group Edit:", None))
        self.btn_add_layer.setText(_translate("GroupEditorMainWindow", "Add database layer to map", None))
